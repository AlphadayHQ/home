      ...
      <section className="fixed overflow-hidden w-full bottom-0 z-100 bg-[#27292F]">
        <div className="relative flex flex-col flex-wrap justify-center items-center overflow-hidden">
          <div className="flex pt-5 p-2.5 lg:p-5 flex-1 flex-col lg:flex-row w-full max-w-7xl overflow-hidden items-center">
            <div className="mx-auto min-w-70 text-center lg:text-left text-[#C2C5D6] text-xs font-normal leading-6 tracking-wider">
              ...
              {choices
                ...
                .map((item) => (
                  <button
                    ...
                    className={`${
                      item.key === "decline" ? "bg-[#ff5f58]/8" : ""
                    } outline-none inline-flex items-center justify-center tracking-wider text-center align-middle cursor-pointer leading-6 select-none transition-colors hover:outline-none active:outline-none focus:outline-none w-max-content px-10 lg:px-16 mx-2 py-4 min-w-max rounded-[10px] border-2 border-solid 

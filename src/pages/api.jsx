        ...
        <section className="py-24 px-6 bg-surface-light/30 border-y border-surface-border relative overflow-hidden">
          ...
          <div className="max-w-5xl mx-auto flex flex-col lg:flex-row gap-16 items-center">
            ...
            <div className="flex-1 w-full z-10">
              <div className="bg-surface border-t border-x border-surface-border rounded-t-2xl p-4 font-mono text-sm text-text-muted flex items-center gap-2">
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start md:items-center gap-10">
          <div className="flex flex-col gap-4">
            <div className="flex items-center gap-2">
              <Terminal className="text-text-muted w-5 h-5" />
